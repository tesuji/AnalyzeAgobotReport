...
Trong đó có các hàm \texttt{IsVMWare()} để kiểm tra có phải chạy trong máy ảo VMWare,
hàm \texttt{AddHosts()} thêm trỏ danh mục các trang web chống vi-rút đến localhost,
hàm \texttt{IsODBGLoaded()} kiểm tra trình gỡ lỗi OllyDbg, \dots
