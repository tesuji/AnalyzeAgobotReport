...
Ngăn chặn hệ thống đã bị xâm nhập kết nối với máy chủ cập nhật và các trang web liên quan đến bảo mật khác bằng cách thêm phần sau vào tệp HOSTS của máy chủ \ref{code:hosts}:
\begin{listing}[ht]
